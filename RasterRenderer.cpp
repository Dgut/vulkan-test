...
void RasterRenderer::createGraphicsPipeline(Setup& setup)
{
...
void RasterRenderer::createDescriptorSetLayout(Setup& setup) {
...
void RasterRenderer::createDescriptorSets(Setup& setup) {
...
void RasterRenderer::cleanup(VkDevice device) {
...
void RasterRenderer::draw(Setup& setup, VkCommandBuffer commandBuffer, uint32_t currentImage) {

    //updateUniformBuffer(setup, currentImage, ubo);

    vkCmdBindPipeline(commandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, graphicsPipeline);

    VkBuffer vertexBuffers[] = { setup.getVertexBuffer() };
    VkDeviceSize offsets[] = { 0 };
    vkCmdBindVertexBuffers(commandBuffer, 0, 1, vertexBuffers, offsets);

    vkCmdBindIndexBuffer(commandBuffer, setup.getIndexBuffer(), 0, VK_INDEX_TYPE_UINT32);
    ...
    vkCmdDrawIndexed(commandBuffer, static_cast<uint32_t>(setup.getIndices().size()), 1, 0, 0, 0);
}
